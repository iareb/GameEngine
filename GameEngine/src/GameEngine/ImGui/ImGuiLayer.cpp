...
namespace GameEngine {
	...
	void ImGuiLayer::OnAttach()
	{
        ...
        // Imposta il flag HasSetMousePos per indicare che il backend può anche impostare la posizione del mouse.
        // Questo può essere utile per il controllo del mouse in alcune interazioni.
	...
	void ImGuiLayer::OnUpdate()
	{
        ...
        // ImVec2 è un vettore 2D usato per salvare info su posizione, dimensioni ecc.
        io.DisplaySize = ImVec2(app.GetWindow().GetWidth(), app.GetWindow().GetHeight());

        // Ottiene il tempo corrente dal sistema (utilizzando GLFW).
        // Questo tempo verrà utilizzato per calcolare il delta time, cioè il tempo trascorso dall'ultimo aggiornamento del frame.
        ...
        // Viene passato a RenderDrawData il contenuto da disegnare, che è stato preparato da ImGui durante il frame.
